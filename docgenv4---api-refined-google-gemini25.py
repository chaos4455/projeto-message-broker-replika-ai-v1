...
NOME_MODELO = "gemini-2.0-flash-thinking-exp-01-21" # Modelo mais rápido e geralmente suficiente
...
def gerar_relatorio_ia(
    ...
    EU QUERO QUE AGORA NAO FOQUE NA ARQUITETURA GERAL, FOQUE NA API, 100 % NA API, É DOCUMENTACAO DE ARQUITETURA E DESIGN, SEGURANÇA, ETC, MAS FOCADO NA API  - DETALHE ELA DO BASICO SUPERFICIAL QUE É ENDEREO, PORTA ATE O FUNDO DO FUNDO DO FUNDO INCLUSIVE NA ARQUITTURA E NA BIBLIOTECA QUE FOI USADA, ETC
    
    EM COMO FAZ,O QUE FAZ, POR QUE FAZ, ETC
    
    EU QUERO QUE EM CIMA DE CADA BLOCO TENHA UM TRECHO AANÇADO DETALHADO A ESCOLHA DE DESIGN E ARQUITETURA DAQUELE COMPONENTE EM 5 TOPICOS
