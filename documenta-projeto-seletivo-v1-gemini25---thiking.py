...
try:
    ...
    #     print(m.name)
    NOME_MODELO = "gemini-2.0-flash-thinking-exp-01-21" # Modelo mais recente e geralmente capaz
...
def generate_documentation(code_snippets: Dict[str, str], user_prompt: str) -> str:
    ...
    sempre responda o mais longo, mais de 1200 linhas, use icones, emojis, aprofunde, detalhe, crie personas, faça comentarios, foque em documentar, nao propor melhorias ao longo de tudo, foque em documentar, o que é, cmo faz,o que faz, pra que serve, etc, e seja original
    
    documente nonivel estado da arte - seja tecnicoc e avançado, arquiteto e phd em arquitetura de sistemas
    
    use formatação rica, seja imersivo e profissional - assine as documentações como elias andrade - replika ai solutions maringá paraná  - 
